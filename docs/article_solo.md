# 我花了 43 分钟试图解密 Trae SOLO CN 数据库，发现了完全不同的加密世界
...
Trae SOLO CN 使用了一种完全不同的加密架构。我花了 6 小时，尝试了所有我能想到的方法，全部失败。
...
```
C:/Users/86150/AppData/Roaming/TRAE SOLO CN/ModularData/ai-agent/database.db
```
...
我开始分析 Trae SOLO CN 的源代码。在 `D:/apps/TRAE SOLO CN/resources/app/out/main.js` 中，我找到了关键代码：
...
我花了 6 小时，没有解密 Trae SOLO CN 的数据库。
...
*如果你也遇到了类似的问题，希望这篇文章能帮你节省 43 分钟。*
